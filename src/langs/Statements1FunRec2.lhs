...
> module Statements1FunRec2 (tests
>                           ) where
...
> tests :: T.TestTree
> tests = T.testGroup "Statements1FunRec2" [tests1,tests2]

> tests1 :: T.TestTree
> tests1 = T.makeTestsIO "Statements1FunRec2a" $ pure (evaluateWithChecks simpleTestScript)

> tests2 :: T.TestTree
> tests2 = T.makeTestsIO "Statements1FunRec2b" $ pure (evaluateWithChecks recursiveTests)
