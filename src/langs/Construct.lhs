...
Implement generic construct expressions
...
> tests :: T.TestTree
> tests = T.testGroup "construct" [tests1,tests2,tests3]

> tests1 :: T.TestTree
> tests1 = T.makeTestsIO "constructa" $ pure (evaluateWithChecks simpleTestScript)

> tests2 :: T.TestTree
> tests2 = T.makeTestsIO "constructb" $ pure (evaluateWithChecks listTests)

> tests3 :: T.TestTree
> tests3 = T.makeTestsIO "constructc" $ pure (evaluateWithChecks constructTests)
