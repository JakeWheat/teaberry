...
Extend the repl idea into the start of a complete embedded api
...
how to abstract away the interpreter monad for ffi functions?
is it worth making interpreter methods available to ffi functions
...
> runInterp :: Env -> Expr -> Either String (Value, Env, [T.CheckResult])
> runInterp env expr =
...
> evaluateFull :: Env -> String -> Either String (Value, Env, [T.CheckResult])
...
>     in T.makeTests "records1embedded1" crs

> tests :: T.TestTree
> tests = T.testGroup "records1embedded" [tests1,tests2]


> tests2 :: T.TestTree
> tests2 = T.testGroup "embeddedtests2"
>     [testSanityArith
>     ,testEnvKept
>     ,testEnvOverridden
>     ,testAScript
